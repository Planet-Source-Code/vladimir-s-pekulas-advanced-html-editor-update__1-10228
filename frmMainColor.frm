...
Begin VB.Form frmColor 
   ...
   Begin VB.PictureBox Light 
      ...
      Height          =   2850
      Left            =   2880
      MouseIcon       =   "frmMainColor.frx":0E42
   ...
   Begin VB.PictureBox Picker1 
      ...
      Height          =   2850
      Left            =   120
      MouseIcon       =   "frmMainColor.frx":114C
      MousePointer    =   99  'Custom
      Picture         =   "frmMainColor.frx":1456
      ScaleHeight     =   2790
      ScaleWidth      =   2625
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   255
      Left            =   120
      MouseIcon       =   "frmMainColor.frx":19438
      MousePointer    =   99  'Custom
      Picture         =   "frmMainColor.frx":19742
      ScaleHeight     =   255
      ScaleWidth      =   3000
      TabIndex        =   0
      TabStop         =   0   'False
...
BTransfer = txtB.Text
'# Set values
'SelColor(0) = RTransfer
'SelColor(1) = GTransfer
'SelColor(2) = BTransfer
'frmDocument.rtfText.SelRTF = HexTransfer
fMainForm.ActiveForm.rtfText.SelText = HexTransfer
Unload Me
End Sub
